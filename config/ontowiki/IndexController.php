...
class IndexController extends OntoWiki_Controller_Base
{
    ...
    public function newsAction()
    {
        ...
        $this->view->placeholder('main.window.title')->set('Heloïse - European Workshop on academic Databases');

            try {
            $url = 'http://heloise.hypotheses.org/category/actualites-news/feed';
